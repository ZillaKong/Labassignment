                        ...
                        <form method="POST" action="" class="mt-4" id="register-form">
                            ...
                            <div class="mb-3">
                             ...
                             <div class="mb-3">
                                ...
                                <input type="text" class="form-control animate__animated animate__fadeInUp" id="country" name="phone_number" required>
                            </div>
                             <div class="mb-3">
                                <label for="city" class="form-label">City </label>
                                <input type="text" class="form-control animate__animated animate__fadeInUp" id="city" name="phone_number" required>
                            </div>
                            <div class="mb-4">
                                ...
                                <div class="d-flex justify-content-start">
                                    ...
                                    <div class="form-check custom-radio">
                                        ...
                                        <label class="form-check-label" for="sellers">Sellers</label>
                                    </div>
                                </div>
                            </div>
